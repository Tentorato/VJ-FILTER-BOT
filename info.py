...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1722409366').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002000438745'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001973645984').split()]  # For Multiple Id Use One Space Between Each.
...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1001973645984').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002000438745')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002000438745')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ZAYOTA_1:Rounak2222@cluster01.0iqva4r.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+JQFVeyMyIiJiYmY9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ZoneFlixTv')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+JQFVeyMyIiJiYmY9') # Support Chat Link Without https:// or @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hwtododk/14') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
