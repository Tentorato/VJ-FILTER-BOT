...
PICS = (environ.get('PICS', 'https://envs.sh/afL.jpg')).split()
...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1001973645984, -1002257418506').split()]
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/axK.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+pIf0n14aYxMwYmE1')
